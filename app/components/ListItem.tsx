  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imagesContainer}>
        ...
        <Image source={{ uri: "https://placehold.co/400" }} style={styles.imageLeft} />
        <Image source={{ uri: "https://placehold.co/400" }} style={styles.imageLeft} />
      </View>
